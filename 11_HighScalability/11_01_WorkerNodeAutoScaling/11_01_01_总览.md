...
## 3.2 Pod scheduling: Use label as constraints
...
### 4.2.1 Handling the existing nodes
...
### 4.2.3 Node management and lifecycle rule via NodePool
...
## 7.2 Computer per workload scheduling requirements
...
### 7.2.1 Pod Tolerations and Node Taints 
