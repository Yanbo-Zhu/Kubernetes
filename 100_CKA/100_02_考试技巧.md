...
去 killercoda.com/sachin/cour… 刷题，玩 k8s 的一定要收藏这个网站，各种模拟环境让你不用在自己电脑或者服务器上安装 k8s 就能玩。
 ...
 - 做每道题之前一定要记得切换集群，考试页面不能ctrl+c复制，ctrl+v粘贴，用 ctrl + insert复制，shift+insert粘贴
...
## 3.7 利用 kubectl command help 查看创建资源示例
...
## 3.8 采用 kubectl explain 来查看 resource 的定义
